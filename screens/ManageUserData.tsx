      ...
      <View>
        <Input
          ...
          textInputConfig={{
            ...
            autoCorrect: false,
            onChangeText: handleTextChange.bind("firstName"),
        ...
        <Input
          ...
          textInputConfig={{
            autoCapitalize: "sentences",
            autoCorrect: false,
            onChangeText: handleTextChange.bind("lastName"),
        ...
        <Input
          ...
          textInputConfig={{
            ...
            onChangeText: handleTextChange.bind("phoneNumber"),
            placeholder: "###-###-####",
            maxLength: 12,
